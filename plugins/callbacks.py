        ...
        if data == "home":
            await query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/AYU_BOTS'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/+XY7laiOgUmk2NWM1')],
                    [InlineKeyboardButton('• ᴀʙᴏᴜᴛ', callback_data='about'), InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ •', url='https://t.me/Ayu_contact_bot')]
                ])
            )
        elif data == "caption":
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/+XY7laiOgUmk2NWM1'), InlineKeyboardButton("ʙᴀᴄᴋ •", callback_data="help")]
                ])
            )
        elif data == "help":
            await query.message.edit_text(
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ᴏᴡɴᴇʀ •", url='https://t.me/AYU_BOTS')]
                ])
            )

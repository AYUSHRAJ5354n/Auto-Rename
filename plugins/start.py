        ...
        try:
            ...
            try:
                ...
                await message.reply_text(
                    f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @Ayu_contact_bot</i></b>\n"
...
async def show_start_message(client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [
            ...
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/+XY7laiOgUmk2NWM1')
        ],
        [
            InlineKeyboardButton('• ᴀʙᴏᴜᴛ', callback_data='about'),
            InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ•', url='https://t.me/Ayu_contact_bot')
        ]
    ])
...
async def send_verification_message(client, message: Message):
    ...
    if not shortlink:
        await message.reply_text(
            "Eʀʀᴏʀ ɢᴇɴᴇʀᴀᴛɪɴɢ sʜᴏʀᴛʟɪɴᴋ. Pʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ ʟᴀᴛᴇʀ ᴏʀ ᴄᴏɴᴛᴀᴄᴛ @Ayu_contact_bot."
        )
        return None
